...
- Tenant presence: client caches snapshot/deltas; `createTenantPresenceTracker` hydrates from cache (fixes late UI wiring showing 0 online)
- Requires gateway connect fix that includes the connecting socket in Redis presence sync
